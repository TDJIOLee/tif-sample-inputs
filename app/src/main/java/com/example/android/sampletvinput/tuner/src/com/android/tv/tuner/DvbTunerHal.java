...
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.DvbDeviceAccessor.DvbDeviceInfoWrapper;
...
public class DvbTunerHal extends TunerHal {
    ...
    protected static final String TAG = "DvBTunerHal";
    ...
    protected boolean openFirstAvailable() {
        if (DEBUG) Log.d(TAG, "openFirstAvailable");
    ...
    protected int openDvbFrontEndFd() {
        if (DEBUG) Log.d(TAG, "openDvbFrontEndFd");
        if (mDvbDeviceInfo != null) {
    ...
    protected int openDvbDemuxFd() {
        if (DEBUG) Log.d(TAG, "openDvbDemuxFd");
        if (mDvbDeviceInfo != null) {
            ParcelFileDescriptor descriptor =
                    mDvbDeviceAccessor.openDvbDevice(
    ...
    protected int openDvbDvrFd() {
        if (DEBUG) Log.d(TAG, "openDvbDvrFd");
        if (mDvbDeviceInfo != null) {
            ParcelFileDescriptor descriptor =
                    mDvbDeviceAccessor.openDvbDevice(
    ...
    public static int getNumberOfDevices(Context context) {
        if (DEBUG) Log.d(TAG, "getNumberOfDevices");
        try {
