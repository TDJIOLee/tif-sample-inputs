...
public class TvInputPlayer implements TextRenderer {
    ...
    public void prepare(Context context, final Uri uri, int sourceType) {
		Log.d(TAG,"xxx prepare TvInputPlayer uri=" + uri.toString() + ", type=" + sourceType);
    ...
    public void setPlayWhenReady(boolean playWhenReady) {
		Log.d(TAG,"xxx setPlayWhenReady TvInputPlayer");
        mPlayer.setPlayWhenReady(playWhenReady);
    }
    ...
    public void stop() {
		Log.d(TAG,"xxx stop TvInputPlayer");
        mPlayer.stop();
    }
    ...
    private void prepareInternal() {
		Log.d(TAG,"xxx prepareInternal TvInputPlayer");
