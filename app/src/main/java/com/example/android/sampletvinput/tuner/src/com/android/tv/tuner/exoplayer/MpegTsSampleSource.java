...
public final class MpegTsSampleSource implements SampleSource/*, SampleSourceReader*/ {
    ...
    //@Override
    public MpegTsSampleSource register() {
    ...
    @Override
    public TrackInfo getTrackInfo(int info) {
        return null;
    }
    ...
    @Override
    public int readData(
            int track, long positionUs, MediaFormatHolder formatHolder, SampleHolder sampleHolder, boolean Bool) {
        // Do nothing
        return 0;
    }
