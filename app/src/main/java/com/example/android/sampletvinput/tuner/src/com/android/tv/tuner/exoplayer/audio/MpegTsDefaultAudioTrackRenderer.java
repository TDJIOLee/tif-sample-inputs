...
package com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.audio;
...
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.MpegTsSampleSource;
...
public class MpegTsDefaultAudioTrackRenderer extends TrackRenderer implements MediaClock {
    ...
    private final MpegTsSampleSource mSource;
    ...
    private boolean handlesMimeType(String mimeType) throws MediaCodecUtil.DecoderQueryException {
    ...
    @Override
    protected  int doPrepare() { return 0; }

    @Override
    public PlaybackParameters getPlaybackParameters() {
        return this.getPlaybackParameters();
    }

    @Override
    public PlaybackParameters setPlaybackParameters(PlaybackParameters playbackParameters) {
        if (this != null) {
            playbackParameters = this.setPlaybackParameters(playbackParameters);
    ...
    @Override
    protected long getCurrentPositionUs() { return 0; }
    ...
    private void readFormat() throws IOException, ExoPlaybackException, MediaCodecUtil.DecoderQueryException {
        int result =
    ...
    private void onInputFormatChanged(MediaFormatHolder formatHolder) throws ExoPlaybackException, MediaCodecUtil.DecoderQueryException {
    ...
    private boolean feedInputBuffer() throws IOException, ExoPlaybackException, MediaCodecUtil.DecoderQueryException {
        ...
        if (mUseFrameworkDecoder) {
            ...
            if (indexChanged) {
                ...
                if (mSampleHolder.data != null) {
                    mSampleHolder.data.clear(); //mSampleHolder.clearData();
                } else {
                    return false;
                }
            }
    ...
    protected long getDurationUs() {
        return 0; //mSource.getFormat(mTrackIndex).durationUs;
    }
