...
package com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.tvinput;
...
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.TunerPreferences;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.data.Cea708Data;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.data.PsipData.EitItem;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.data.PsipData.TvTracksInterface;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.data.TunerChannel;
...
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.MpegTsPlayer;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.MpegTsRendererBuilder;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.buffer.BufferManager;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.buffer.BufferManager.StorageManager;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.buffer.DvrStorageManager;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.buffer.TrickplayStorageManager;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.source.TsDataSource;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.source.TsDataSourceManager;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.util.StatusTextUtils;
...
public class TunerSessionWorker
    ...
    private void startCaptionTrack() {
        if (mCaptionEnabled && mCaptionTrack != null) {
            ...
            if (mPlayer != null) {
                mPlayer.setCaptionServiceNumber(mCaptionTrack.toBuilder().getServiceNumber());
            }
        }
    }
    ...
    private void updateAudioTracks(List<AtscAudioTrack> audioTracks) {
        ...
        if (audioTracks != null) {
            ...
            for (AtscAudioTrack audioTrack : audioTracks) {
                audioTrack.toBuilder().setIndex(index);
        ...
        for (int i = 0; i < audioTrackCount; i++) {
            ...
            AtscAudioTrack infoFromVct =
                    (mChannel != null
                            ...
                            : null;
            String language =
                    (infoFromEit != null && infoFromEit.getLanguage() != null)
                        ? infoFromEit.getLanguage()
                        : (infoFromVct != null && infoFromVct.getLanguage() != null)
    ...
    private void updateChannelInfo(TunerChannel channel) {
        ...
        List<Channel.AudioStreamType> audioStreamTypes = channel.getAudioStreamTypes();
    ...
    private void doDiscoverCaptionServiceNumber(int serviceNumber) {
        ...
        if (index < 0) {
            ...
            captionTrack.setServiceNumber(serviceNumber);
            captionTrack.setWideAspectRatio(false);
            captionTrack.setEasyReader(false);
            mCaptionTrackMap.put(serviceNumber, captionTrack.build());
            mTvTracks.add(
                    new TvTrackInfo.Builder(
                                    TvTrackInfo.TYPE_SUBTITLE,
