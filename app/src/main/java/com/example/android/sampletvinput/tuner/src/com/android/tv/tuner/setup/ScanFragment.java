...
package com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.setup;
...
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.ChannelScanFileParser;
import com.example.android.sampletvinput.R;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.TunerHal;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.TunerPreferences;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.data.PsiData;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.data.PsipData;
...
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.source.FileTsStreamer;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.source.TsDataSource;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.source.TsStreamer;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.source.TunerTsStreamer;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.tvinput.ChannelDataManager;
...
public class ScanFragment extends SetupFragment {
    ...
    private class ChannelScanTask extends AsyncTask<Void, Integer, Void>
        ...
        private TsStreamer getStreamer(int type) {
            switch (type) {
                case Channel.TunerType.TYPE_TUNER_VALUE:
                    return mScanTsStreamer;
                case Channel.TunerType.TYPE_FILE_VALUE:
    ...
    private static class FakeTsStreamer implements TsStreamer {
        ...
        public boolean startStream(ChannelScanFileParser.ScanChannel channel) {
            ...
            mEventListener.onChannelDetected(
                    new TunerChannel(mProgramNumber, new ArrayList<PsiData.PmtItem>()) {
                        @Override
