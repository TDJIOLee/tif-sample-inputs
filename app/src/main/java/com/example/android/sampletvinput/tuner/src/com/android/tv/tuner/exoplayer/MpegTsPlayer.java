...
package com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer;
...
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.data.Cea708Data.CaptionEvent;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.data.TunerChannel;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.audio.MpegTsDefaultAudioTrackRenderer;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.exoplayer.audio.MpegTsMediaCodecAudioTrackRenderer;
...
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.tvinput.EventDetector;
import com.example.android.sampletvinput.tuner.src.com.android.tv.tuner.tvinput.TunerDebug;
...
public class MpegTsPlayer
    ...
    public void setSelectedTrack(int rendererIndex, int trackIndex) {
        ...
        setSelectedTrack(rendererIndex, trackIndex);
    }
    ...
    public int getSelectedTrack(int rendererIndex) {
        return getSelectedTrack(rendererIndex);
    }
    ...
    public MediaFormat getTrackFormat(int rendererIndex, int trackIndex) {
        return getTrackFormat(rendererIndex, trackIndex);
    }
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int state) {
        ...
        if (state == ExoPlayer.STATE_READY
                && getTrackCount(TRACK_TYPE_VIDEO) > 0
                && playWhenReady) {
            MediaFormat format = getTrackFormat(TRACK_TYPE_VIDEO, 0);
            mListener.onVideoSizeChanged(format.width, format.height, 0, format.pixelWidthHeightRatio);
        }
    }
    ...
    private void pushTrackSelection(@TrackType int type, boolean allowRendererEnable) {
        ...
        setSelectedTrack(type, allowRendererEnable ? 0 : -1);
    }
