...
public class PsiData {
    ...
    public static class PmtItem {
        ...
        private final List<AtscAudioTrack> mAudioTracks; //List<AtscAudioTrack> mAudioTracks;
        private final List<AtscCaptionTrack> mCaptionTracks; //List<AtscCaptionTrack> mCaptionTracks;

        public PmtItem(
                int streamType,
                int esPid,
                List<AtscAudioTrack> audioTracks, //List<AtscAudioTrack> audioTracks
                List<AtscCaptionTrack> captionTracks) { //List<AtscCaptionTrack> captionTracks
        ...
        public List<AtscCaptionTrack> getCaptionTracks() {  //List<AtscCaptionTrack> getCaptionTracks()
